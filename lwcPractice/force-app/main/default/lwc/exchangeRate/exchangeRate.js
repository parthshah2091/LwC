...
export default class ExchangeRate extends LightningElement {
        ...
        apiUrl = "http://data.fixer.io/api/latest?access_key=25bd3be7e49f641c5f9acd01a07d53f0";
        // outputObject=[];
        @track error;
        @track search;
        ...
        handleBtnClick(){ 
            ...
            this.delayTimeout = setTimeout(()=>{
                getCalloutResponseContents({mainUrl:this.apiUrl}).then(result=>{
