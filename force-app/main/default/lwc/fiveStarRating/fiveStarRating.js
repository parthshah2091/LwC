...
import EditedAttribute from '@salesforce/schema/FeedRevision.EditedAttribute';
// add constants here
...
export default class FiveStarRating extends LightningElement {
  ...
  ratingChanged(CURRENT_RATING) {
    this.dispatchEvent(new CustomEvent('ratingchange', { detail: { rating: CURRENT_RATING } }));
  }
}